...
INSERT INTO `surveys` VALUES (11,'Oplysningsskema 18 aar','INFO','Oplysningsskema (Ungeskema)','16-18','youth','f23737',99,'info18','INFO18');
...
INSERT INTO `question_cells` VALUES (2760,1100,'Placeholder',1,5,NULL,NULL,'placeholder::::',NULL,0,NULL,NULL,NULL);
INSERT INTO `question_cells` VALUES (2761,1100,'SectionSubtitle',1,6,NULL,NULL,'sectionsubtitle::::Oplysninger om pårørende:',NULL,0,NULL,NULL,NULL);
INSERT INTO `question_cells` VALUES (2762,1100,'ListItem',1,7,"8",NULL,'listitem::::Navn:',NULL,0,NULL,NULL,NULL);
INSERT INTO `question_cells` VALUES (2763,1100,'ListItemComment',2,7,"8",NULL,'listitem::::',NULL,0,NULL,NULL,NULL);
INSERT INTO `question_cells` VALUES (2764,1100,'ListItem',1,8,"8",NULL,'listitem::::Familieforhold: (ex. mor, far, bonusforældre)',NULL,0,NULL,NULL,NULL);
INSERT INTO `question_cells` VALUES (2765,1100,'ListItemComment',2,8,"8",NULL,'itemunit::::',NULL,0,NULL,NULL,NULL);
INSERT INTO `question_cells` VALUES (2766,1100,'ListItem',1,9,"8",NULL,'listitem::::Telefonnr:',NULL,0,NULL,NULL,NULL);
INSERT INTO `question_cells` VALUES (2767,1100,'ListItemComment',2,9,"8",NULL,'listitem::::',NULL,0,NULL,NULL,NULL);
...
INSERT INTO `questions` VALUES (1101,11,3,0,3,NULL);
...
INSERT INTO `question_cells` VALUES (2791,1101,'Information',1,8,NULL,NULL,'information::::”Har du indenfor de sidste 6 mdr., været henvist og dermed udfyldt nedenstående spørgsmål, bedes du se bort fra udfyldelse af resten af skemaet.<p/>Hvis der er tilkommet ændringer i oplysningerne bedes disse tilføjet”.',NULL,0,NULL,NULL,NULL)


INSERT INTO `questions` VALUES (1102,11,4,0,2,NULL);
INSERT INTO `question_cells` VALUES (2830,1102,'ListItem',1,1,"7",NULL,'listitem::::Er du allergisk over for noget?',NULL,1,NULL,NULL,NULL);
INSERT INTO `question_cells` VALUES (2831,1102,'Rating',2,1,"2",NULL,'radio::0::Nej###radio::1::Ja','--- \n:switch: \n- a\n',1,11,NULL,NULL);
INSERT INTO `question_cells` VALUES (2832,1102,'ListItemComment',3,1,"2;11",NULL,'listitem::::Hvis ja, for hvad?###textbox::::','--- \n:targets: \n- :target: a\n  :state: offstate\n',0,NULL,NULL,NULL);

INSERT INTO `questions` VALUES (1103,11,5,0,3,NULL);
INSERT INTO `question_cells` VALUES (2843,1103,'Questiontext',1,1,NULL,NULL,'questiontext::::Er der nogle i din familie (1. leds slægtninge) der har psykiske og fysiske vanskeligheder?',NULL,0,NULL,NULL,NULL);
INSERT INTO `question_cells` VALUES (2844,1103,'ListItem',1,2,NULL,NULL,'listitem::::Mor',NULL,0,NULL,NULL,NULL);
INSERT INTO `question_cells` VALUES (2845,1103,'Rating',2,2,"2",NULL,'radio::0::Nej###radio::1::Ja','--- \n:switch: \n- u\n',0,11,NULL,NULL);
INSERT INTO `question_cells` VALUES (2846,1103,'ListItemComment',3,2,"8",NULL,'listitem::::Personens alder ved sygdomsstart - år, og hvilken sygdom###textbox::::','--- \n:targets: \n- :target: u\n  :state: offstate\n',0,NULL,NULL,NULL);
INSERT INTO `question_cells` VALUES (2847,1103,'ListItem',1,3,NULL,NULL,'listitem::::Far',NULL,0,NULL,NULL,NULL);
INSERT INTO `question_cells` VALUES (2848,1103,'Rating',2,3,"2",NULL,'radio::0::Nej###radio::1::Ja','--- \n:switch: \n- v\n',0,11,NULL,NULL);
INSERT INTO `question_cells` VALUES (2849,1103,'ListItemComment',3,3,"8",NULL,'listitem::::Personens alder ved sygdomsstart - år, og hvilken sygdom###textbox::::','--- \n:targets: \n- :target: v\n  :state: offstate\n',0,NULL,NULL,NULL);
...
INSERT INTO `question_cells` VALUES (2950,1103,'Rating',2,7,"2",NULL,'radio::0::Nej###radio::1::Ja','--- \n:switch: \n- ab\n',0,11,NULL,NULL);
INSERT INTO `question_cells` VALUES (2951,1103,'ListItemComment',3,7,"3;8",NULL,'listitem::::Hvis ja, uddyb###textbox::::','--- \n:targets: \n- :target: ab\n  :state: offstate\n',0,NULL,NULL,NULL);
-- INSERT INTO `question_cells` VALUES (2469,1002,'TextBox',2,6,NULL,NULL,'textbox::::',NULL,0,NULL,NULL,NULL);


INSERT INTO `questions` VALUES (1104,11,6,0,3,NULL);
INSERT INTO `question_cells` VALUES (3000,1104,'SectionTitle',1,1,NULL,NULL,'sectiontitle::::Sundhedsoplysninger',NULL,0,NULL,NULL,NULL);
INSERT INTO `question_cells` VALUES (3001,1104,'SectionSubtitle',1,2,NULL,NULL,'sectionsubtitle::::Graviditet og fødsel:',NULL,0,NULL,NULL,NULL);

INSERT INTO `question_cells` VALUES (3002,1104,'ListItem',1,3,NULL,NULL,'listitem::::Var der sygdom hos din mor under graviditeten?',NULL,1,NULL,NULL,NULL);
INSERT INTO `question_cells` VALUES (3003,1104,'Rating',2,3,"1",NULL,'radio::0::Nej###radio::1::Ja','--- \n:switch: \n- c\n',1,11,NULL,NULL);
INSERT INTO `question_cells` VALUES (3004,1104,'ListItemComment',3,3,"4;10",NULL,'listitem::::Hvis ja, beskriv hvilken###textbox::::','--- \n:targets: \n- :target: c\n  :state: offstate\n',0,NULL,NULL,NULL);


INSERT INTO `question_cells` VALUES (3006,1104,'ListItem',1,5,NULL,NULL,'listitem::::Tog din mor medicin under graviditeten?',NULL,1,NULL,NULL,NULL);
INSERT INTO `question_cells` VALUES (3007,1104,'Rating',2,5,NULL,NULL,'radio::0::Nej###radio::1::Ja','--- \n:switch: \n- d\n',1,11,NULL,NULL);
INSERT INTO `question_cells` VALUES (3008,1104,'ListItemComment',3,5,"4;10",NULL,'listitem::::Hvis ja, beskriv hvilken###textbox::::','--- \n:targets: \n- :target: d\n  :state: offstate\n',0,NULL,NULL,NULL);

INSERT INTO `question_cells` VALUES (3009,1104,'ListItem',1,7,NULL,NULL,'listitem::::Var der komplikationer i graviditeten?',NULL,1,NULL,NULL,NULL);
INSERT INTO `question_cells` VALUES (3010,1104,'Rating',2,7,NULL,NULL,'radio::0::Nej###radio::1::Ja','--- \n:switch: \n- e\n',1,11,NULL,NULL);
INSERT INTO `question_cells` VALUES (3011,1104,'ListItemComment',3,7,"4;10",NULL,'listitem::::Hvis ja, beskriv hvilke###textbox::::','--- \n:targets: \n- :target: e\n  :state: offstate\n',0,NULL,NULL,NULL);

INSERT INTO `question_cells` VALUES (3012,1104,'ListItem',1,9,NULL,NULL,'listitem::::Var der komplikationer under fødslen?',NULL,1,NULL,NULL,NULL);
INSERT INTO `question_cells` VALUES (3013,1104,'Rating',2,9,NULL,NULL,'radio::0::Nej###radio::1::Ja','--- \n:switch: \n- f\n',1,11,NULL,NULL);
INSERT INTO `question_cells` VALUES (3014,1104,'ListItemComment',4,9,"4;10",NULL,'listitem::::Hvis ja, beskriv hvilke###textbox::::','--- \n:targets: \n- :target: f\n  :state: offstate\n',0,NULL,NULL,NULL);

INSERT INTO `question_cells` VALUES (3015,1104,'ListItem',1,11,NULL,NULL,'listitem::::Røg din mor tobak under graviditeten?',NULL,1,NULL,NULL,NULL);
INSERT INTO `question_cells` VALUES (3016,1104,'Rating',2,11,NULL,NULL,'radio::0::Nej###radio::1::Ja','--- \n:switch: \n- g\n',1,11,NULL,NULL);
INSERT INTO `question_cells` VALUES (3017,1104,'ListItemComment',3,11,"4;10",NULL,'listitem::::Hvis ja, ca. hvor meget?###textbox::::','--- \n:targets: \n- :target: g\n  :state: offstate\n',0,NULL,NULL,NULL);

INSERT INTO `question_cells` VALUES (3018,1104,'ListItem',1,13,NULL,NULL,'listitem::::Drak din mor alkohol under graviditeten?',NULL,1,NULL,NULL,NULL);
INSERT INTO `question_cells` VALUES (3019,1104,'Rating',2,13,NULL,NULL,'radio::0::Nej###radio::1::Ja','--- \n:switch: \n- h\n',1,11,NULL,NULL);
INSERT INTO `question_cells` VALUES (3020,1104,'ListItemComment',3,13,"4;10",NULL,'listitem::::Hvis ja, ca. hvor meget?###textbox::::','--- \n:targets: \n- :target: h\n  :state: offstate\n',0,NULL,NULL,NULL);
...
INSERT INTO `question_cells` VALUES (3030,1104,'ListItem',1,19,NULL,NULL,'listitem::::Har du medfødte sygdomme?',NULL,1,NULL,NULL,NULL);
INSERT INTO `question_cells` VALUES (3031,1104,'Rating',2,19,1,NULL,'radio::0::Nej###radio::1::Ja','--- \n:switch: \n- i\n',1,11,NULL,NULL);
INSERT INTO `question_cells` VALUES (3032,1104,'ListItemComment',3,19,"4;10",NULL,'listitem::::Hvis ja, beskriv hvilke###textbox::::','--- \n:targets: \n- :target: i\n  :state: offstate\n',0,NULL,NULL,NULL);
...
INSERT INTO `questions` VALUES (1106,11,7,0,3,NULL);
...
INSERT INTO `question_cells` VALUES (3140,1106,'ListItem',1,22,"8",NULL,'listitem::::Går du i skole eller andet?',NULL,1,NULL,NULL,NULL);
INSERT INTO `question_cells` VALUES (3141,1106,'Rating',2,22,NULL,NULL,'radio::0::Nej###radio::1::Ja###radio::2::Andet','--- \n:switch: \n- m\n',1,11,NULL,NULL);
INSERT INTO `question_cells` VALUES (3142,1106,'ListItemComment',1,23,NULL,NULL,'listitem::::Barnets skole (navn og adresse)###textbox::::','--- \n:targets: \n- :target: m\n  :state: offstate\n',1,NULL,NULL,NULL);
-- INSERT INTO `question_cells` VALUE31(261106005,'ListItemComment',2,12,NULL,NULL,'listitem::::','--- \n:targets: \n- :target: m\n  :state: offstate\n',1,NULL,NULL,NULL);
INSERT INTO `question_cells` VALUES (3143,1106,'ListItemComment',1,24,NULL,NULL,'listitem::::Klasselærer/kontaktperson###textbox::::','--- \n:targets: \n- :target: m\n  :state: offstate\n',1,NULL,NULL,NULL);
-- INSERT INTO `question_cells` VALUE31(261106005,'ListItemComment',2,13,NULL,NULL,'listitem::::','--- \n:targets: \n- :target: m\n  :state: offstate\n',1,NULL,NULL,NULL);
INSERT INTO `question_cells` VALUES (3144,1106,'ListItemComment',1,25,NULL,NULL,'listitem::::SFO (navn / adresse / kontaktperson)###textbox::::','--- \n:targets: \n- :target: m\n  :state: offstate\n',1,NULL,NULL,NULL);
-- INSERT INTO `question_cells` VALUE31(261106005,'ListItemComment',2,14,NULL,NULL,'listitem::::','--- \n:targets: \n- :target: m\n  :state: offstate\n',1,NULL,NULL,NULL);
INSERT INTO `question_cells` VALUES (3145,1106,'ListItemComment',1,26,NULL,NULL,'listitem::::Eventuelle tidligere skoler, barnet har gået på (navn samt adresse og evt. årstal)###textbox::::','--- \n:targets: \n- :target: m\n  :state: offstate\n',1,NULL,NULL,NULL);

INSERT INTO `question_cells` VALUES (3146,1106,'ListItemComment',1,27,NULL,NULL,'listitem::::Evt. midlertidig opholdsadresse for barnet (døgninstitution o.lign.):###textbox::::',NULL,1,NULL,NULL,NULL);
-- INSERT INTO `question_cells` VALUES (261106005,'TextBox',2,16,NULL,NULL,'###textbox::::',NULL,1,NULL,NULL,NULL);

INSERT INTO `question_cells` VALUES (3147,1106,'Placeholder',1,28,NULL,NULL,'placeholder::::',NULL,1,NULL,NULL,NULL);
INSERT INTO `question_cells` VALUES (3148,1106,'SectionSubtitle',1,29,NULL,NULL,'sectionsubtitle::::PPR - Pædagogisk-Psykologisk-Rådgivning:',NULL,1,NULL,NULL,NULL);
INSERT INTO `question_cells` VALUES (3149,1106,'ListItem',1,30,NULL,NULL,'listitem::::Har du haft kontakt til PPR?',NULL,1,NULL,NULL,NULL);
INSERT INTO `question_cells` VALUES (3150,1106,'Rating',2,30,NULL,NULL,'radio::0::Nej###radio::1::Ja','--- \n:switch: \n- n\n',1,11,NULL,NULL);
INSERT INTO `question_cells` VALUES (3151,1106,'ListItemComment',3,30,"6;9",NULL,'listitem::::I hvilken forbindelse (navn og adresse på psykolog:):###textbox::::','--- \n:targets: \n- :target: n\n  :state: offstate\n',1,NULL,NULL,NULL);

INSERT INTO `question_cells` VALUES (3152,1106,'SectionSubtitle',1,32,NULL,NULL,'sectionsubtitle::::Socialforvaltning:',NULL,0,NULL,NULL,NULL);
INSERT INTO `question_cells` VALUES (3153,1106,'ListItem',1,33,NULL,NULL,'listitem::::Har du haft kontakt til socialforvaltning?',NULL,1,NULL,NULL,NULL);
INSERT INTO `question_cells` VALUES (3154,1106,'Rating',2,33,NULL,NULL,'radio::0::Nej###radio::1::Ja','--- \n:switch: \n- o\n',1,11,NULL,NULL);
INSERT INTO `question_cells` VALUES (3155,1106,'ListItemComment',3,33,"6;9",NULL,'listitem::::I hvilken forbindelse (navn og adresse på sagsbehandler):###textbox::::','--- \n:targets: \n- :target: o\n  :state: offstate\n',1,NULL,NULL,NULL);
...
INSERT INTO `question_cells` VALUES (3160,1106,'ListItem',1,38,NULL,NULL,'listitem::::Andre:',NULL,1,NULL,NULL,NULL);
INSERT INTO `question_cells` VALUES (3161,1106,'Rating',2,38,NULL,NULL,'radio::0::Nej###radio::1::Ja','--- \n:switch: \n- z\n',1,11,NULL,NULL);
INSERT INTO `question_cells` VALUES (3162,1106,'ListItemComment',3,38,"6;9",NULL,'listitem::::I hvilken forbindelse:###textbox::::','--- \n:targets: \n- :target: z\n  :state: offstate\n',1,NULL,NULL,NULL);


INSERT INTO `questions` VALUES (1107,11,9,0,3,NULL);
INSERT INTO `question_cells` VALUES (3163,1107,'SectionSubtitle',1,1,NULL,NULL,'placeholder::::Øvrige sundhedsoplysninger:',NULL,0,NULL,NULL,NULL);
INSERT INTO `question_cells` VALUES (3164,1107,'ListItem',1,2,NULL,NULL,'listitem::::Har du haft fysiske sygdomme / handicaps?',NULL,1,NULL,NULL,NULL);
INSERT INTO `question_cells` VALUES (3165,1107,'Rating',2,2,NULL,NULL,'radio::0::Nej###radio::1::Ja','--- \n:switch: \n- q\n',1,11,NULL,NULL);
INSERT INTO `question_cells` VALUES (3166,1107,'ListItemComment',3,2,"4;12",NULL,'listitem::::Hvis ja, beskriv hvilke###textbox::::','--- \n:targets: \n- :target: q\n  :state: offstate\n',0,NULL,NULL,NULL);

INSERT INTO `question_cells` VALUES (3167,1107,'ListItem',1,4,NULL,NULL,'listitem::::Har du nogensinde været indlagt på sygehus?',NULL,1,NULL,NULL,NULL);
INSERT INTO `question_cells` VALUES (3168,1107,'Rating',2,4,NULL,NULL,'radio::0::Nej###radio::1::Ja','--- \n:switch: \n- r\n',1,11,NULL,NULL);
INSERT INTO `question_cells` VALUES (3169,1107,'ListItemComment',3,4,"6;10",NULL,'listitem::::Hvis ja, for hvilke sygdomme og hvor (afdeling/hospital)###textbox::::','--- \n:targets: \n- :target: r\n  :state: offstate\n',0,NULL,NULL,NULL);

INSERT INTO `question_cells` VALUES (3170,1107,'ListItem',1,5,NULL,NULL,'listitem::::Er du vaccineret efter det almindelige børnevaccinationsprogram?',NULL,1,NULL,NULL,NULL);
INSERT INTO `question_cells` VALUES (3171,1107,'Rating',2,5,NULL,NULL,'radio::1::Ja###radio::0::Nej','--- \n:switch: \n- s\n',1,11,NULL,NULL);
INSERT INTO `question_cells` VALUES (3172,1107,'ListItemComment',3,5,"6;10",NULL,'listitem::::Beskriv eventuelle undtagelser###textbox::::','--- \n:targets: \n- :target: s\n  :state: offstate\n',0,NULL,NULL,NULL);

INSERT INTO `question_cells` VALUES (3173,1107,'ListItem',1,6,NULL,NULL,'listitem::::Får du medicin?',NULL,1,NULL,NULL,NULL);
INSERT INTO `question_cells` VALUES (3174,1107,'Rating',2,6,NULL,NULL,'radio::0::Nej###radio::1::Ja','--- \n:switch: \n- t\n',1,11,NULL,NULL);
INSERT INTO `question_cells` VALUES (3175,1107,'Placeholder',1,7,NULL,NULL,'placeholder::::','--- \n:targets: \n- :target: t\n  :state: offstate\n',0,NULL,NULL,NULL);

INSERT INTO `question_cells` VALUES (3180,1107,'ListItemComment',1,8,NULL,NULL,'listitem::::Hvilken medicin###textbox::::','--- \n:targets: \n- :target: t\n  :state: offstate\n',0,NULL,NULL,NULL);
INSERT INTO `question_cells` VALUES (3181,1107,'ListItemComment',2,8,NULL,NULL,'listitem::::For hvad?###textbox::::','--- \n:targets: \n- :target: t\n  :state: offstate\n',1,NULL,NULL,NULL);
INSERT INTO `question_cells` VALUES (3182,1107,'ListItemComment',3,8,NULL,NULL,'listitem::::Hvornår?###textbox::::','--- \n:targets: \n- :target: t\n  :state: offstate\n',1,NULL,NULL,NULL);
-- INSERT INTO `question_cells` VALUE31(261107006,'Placeholder',1,11,NULL,NULL,'placeholder::::','--- \n:targets: \n- :target: t\n  :state: offstate\n',0,NULL,NULL,NULL);
INSERT INTO `question_cells` VALUES (3184,1107,'ListItemComment',1,9,NULL,NULL,'listitem::::Hvilken medicin?###textbox::::','--- \n:targets: \n- :target: t\n  :state: offstate\n',0,NULL,NULL,NULL);
INSERT INTO `question_cells` VALUES (3185,1107,'ListItemComment',2,9,NULL,NULL,'listitem::::For hvad?###textbox::::','--- \n:targets: \n- :target: t\n  :state: offstate\n',1,NULL,NULL,NULL);
INSERT INTO `question_cells` VALUES (3186,1107,'ListItemComment',3,9,NULL,NULL,'listitem::::Hvornår?###textbox::::','--- \n:targets: \n- :target: t\n  :state: offstate\n',1,NULL,NULL,NULL);

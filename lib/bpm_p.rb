...
def create
p = Survey.new({:title => "BPM-P 6-16 forældreskema", :category => "BMP", :age => "6-16", :surveytype => "parent", :prefix => "bpm-p"})
t.save
...
q2_cells = [
Information.new({:question => q2, :col => 1, :row => 1, :answer_item => nil, :items => "information::::Her er en liste over egenskaber, som kan være til stede i større eller mindre grad. Markér for hver egenskab, hvorledes den passer på eleven nu eller de sidste  _______ dage. Marker 2, hvis beskrivelsen passer godt eller ofte. Marker 1, hvis beskrivelsen passer til en vis grad eller nogen gange. Hvis beskrivelsen ikke passer på barnet, mar 0. Svar venligst så godt du kan på alle spørgsmålene. ", :preferences => "", :prop_mask => 0}),

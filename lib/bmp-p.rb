...
t = Survey.new {:title => "BMP-P 6-16 forældreskema", :category => "BMP", :age => "6-16", :surveytype => "parent", :prefix => "bpm-p"}
...
{:question => q, :col => 2, :row => 9, :answer_item => "6", :items => "listitem::::Ødelægger ting der tilhører familier eller andre", :preferences => "", :prop_mask => 0},
{:question => q, :col => 1, :row => 10, :answer_item => "7", :items => "radio::0::0###radio::1::1###radio::2::2", :preferences => { :required => true}, :prop_mask => 1},
{:question => q, :col => 2, :row => 10, :answer_item => "7", :items => "listitem::::Ulydig hjemme", :preferences => "", :prop_mask => 0},
{:question => q, :col => 1, :row => 11, :answer_item => "8", :items => "radio::0::0###radio::1::1###radio::2::2", :preferences => { :required => true}, :prop_mask => 1},
{:question => q, :col => 2, :row => 11, :answer_item => "8", :items => "listitem::::Ulydig i skolen", :preferences => "",	:prop_mask => 0},
{:question => q, :col => 1, :row => 12, :answer_item => "9", :items => "radio::0::0###radio::1::1###radio::2::2", :preferences => { :required => true}, :prop_mask => 1},
{:question => q, :col => 2, :row => 12, :answer_item => "9", :items => "listitem::::Føler sig værdiløs eller underlegen", :preferences => "", :prop_mask => 0},
{:question => q, :col => 1, :row => 13, :answer_item => "10", :items => "radio::0::0###radio::1::1###radio::2::2", :preferences => { :required => true}, :prop_mask => 1},
{:question => q, :col => 2, :row => 13, :answer_item => "10", :items => "listitem::::Impulsiv eller handler uden at tænke", :preferences => "", :prop_mask => 0},
{:question => q, :col => 1, :row => 14, :answer_item => "11", :items => "radio::0::0###radio::1::1###radio::2::2", :preferences => { :required => true}, :prop_mask => 1},
{:question => q, :col => 2, :row => 14, :answer_item => "11", :items => "listitem::::For bange eller ængstelig", :preferences => "", :prop_mask => 0},
{:question => q, :col => 1, :row => 15, :answer_item => "12", :items => "radio::0::0###radio::1::1###radio::2::2", :preferences => { :required => true}, :prop_mask => 1},
{:question => q, :col => 2, :row => 15, :answer_item => "12", :items => "listitem::::Har for stærk skyldfølelse", :preferences => "", :prop_mask => 0},
{:question => q, :col => 1, :row => 16, :answer_item => "13", :items => "radio::0::0###radio::1::1###radio::2::2", :preferences => { :required => true}, :prop_mask => 1},
{:question => q, :col => 2, :row => 16, :answer_item => "13", :items => "listitem::::Bliver let flov eller forlegen", :preferences => "", :prop_mask => 0},
{:question => q, :col => 1, :row => 17, :answer_item => "14", :items => "radio::0::0###radio::1::1###radio::2::2", :preferences => { :required => true}, :prop_mask => 1},
{:question => q, :col => 2, :row => 17, :answer_item => "14", :items => "listitem::::Uopmærksom eller afledes let", :preferences => "", :prop_mask => 0},
{:question => q, :col => 1, :row => 18, :answer_item => "15", :items => "radio::0::0###radio::1::1###radio::2::2", :preferences => { :required => true}, :prop_mask => 1},
{:question => q, :col => 2, :row => 18, :answer_item => "15", :items => "listitem::::Stædig, mut eller irritabel", :preferences => "", :prop_mask => 0},
{:question => q, :col => 1, :row => 19, :answer_item => "16", :items => "radio::0::0###radio::1::1###radio::2::2", :preferences => { :required => true}, :prop_mask => 1},
{:question => q, :col => 2, :row => 19, :answer_item => "16", :items => "listitem::::Anfald af arrigskab eller vrede", :preferences => "", :prop_mask => 0},
{:question => q, :col => 1, :row => 20, :answer_item => "17", :items => "radio::0::0###radio::1::1###radio::2::2", :preferences => { :required => true}, :prop_mask => 1},
{:question => q, :col => 2, :row => 20, :answer_item => "17", :items => "listitem::::Truer folk", :preferences => "",	:prop_mask => 0},
{:question => q, :col => 1, :row => 21, :answer_item => "18", :items => "radio::0::0###radio::1::1###radio::2::2", :preferences => { :required => true}, :prop_mask => 1},
{:question => q, :col => 2, :row => 21, :answer_item => "18", :items => "listitem::::Ulykkelig, trist eller deprimeret", :preferences => "",	:prop_mask => 0},
{:question => q, :col => 1, :row => 22, :answer_item => "19", :items => "radio::0::0###radio::1::1###radio::2::2", :preferences => { :required => true}, :prop_mask => 1},
{:question => q, :col => 2, :row => 22, :answer_item => "19", :items => "listitem::::Bekymrer sig", :preferences => "", :prop_mask => 0},
...
{:question => q, :col => 1, :row => 24, :answer_item => null, :items => "radio::0::0###radio::1::1###radio::2::2", :preferences => { :required => true}, :prop_mask => 1}
{:question => q, :col => 2, :row => 24, :answer_item => null, :items => "listitem::::Yderligere spørgsmål", :preferences => "",	:prop_mask => 0}
]

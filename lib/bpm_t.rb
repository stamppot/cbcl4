...
q1_cells = [
SelectOption.new({:question => q1, :col => 1, :row => 1, :answer_item => "", :items => "listitem::::Klassetrin###option::0::0. klasse###option::1::1. klasse###option::2::2. klasse###option::3::3. klasse###option::4::4. klasse###option::5::5. klasse###option::6::6. klasse###option::7::7. klasse###option::8::8. klasse###option::9::9. klasse###option::10::10. klasse###option::99::Andet", :preferences => {:targets => [{:state => "onstate", :target => "e"}]}, :prop_mask => 1}),
ListItem.new({:question => q1, :col => 2, :row => 1, :answer_item => "", :items => "listitem::::Skole###textbox::::", :preferences => {:targets => [{:state => "onstate", :target => "e"}]}, :prop_mask => 2})
]
q1_cells.each &:save


q2 = Question.new({:number => 1, :ratings_count => 18, :columns => 3, :survey => t})
q2.save

q2_cells = [
Information.new({:question => q2, :col => 1, :row => 1, :answer_item => nil, :items => "information::::Her er en liste over egenskaber, som kan være til stede i større eller mindre grad. Markér for hver egenskab, hvorledes det passer på eleven nu eller de sidste 7 dage (hvis andet ikke er aftalt). Sæt en ring rundt om 2, hvis beskrivelsen passer godt eller ofte. Sæt ring rundt om 1, hvis beskrivelsen passer til en vis grad eller nogen gange. Hvis beskrivelsen ikke passer på barnet, sæt ring om 0. Svar venligst så godt du kan på alle spørgsmålene. ", :preferences => "", :prop_mask => 0}),
ListItem.new({:question => q2, :col => 1, :row => 2, :answer_item => nil, :items => "questiontext::::Hvis aftalt andet end 7 dage, angiv hvor mange dage, det passer på eleven", :preferences => "", :prop_mask => 0}),
...
ListItem.new({:question => q2, :col => 2, :row => 9, :answer_item => "6", :items => "listitem::::Ødelægger ting der tilhører andre", :preferences => "", :prop_mask => 0}),
...
ListItem.new({:question => q2, :col => 2, :row => 10, :answer_item => "7", :items => "listitem::::Ulydig i skolen", :preferences => "", :prop_mask => 0}),
...
ListItem.new({:question => q2, :col => 2, :row => 11, :answer_item => "8", :items => "listitem::::Føler sig værdiløs eller underlegen", :preferences => "", :prop_mask => 0}),
...
ListItem.new({:question => q2, :col => 2, :row => 12, :answer_item => "9", :items => "listitem::::Impulsiv eller handler uden at tænke", :preferences => "", :prop_mask => 0}),
...
ListItem.new({:question => q2, :col => 2, :row => 13, :answer_item => "10", :items => "listitem::::For bange eller ængstelig", :preferences => "", :prop_mask => 0}),
...
ListItem.new({:question => q2, :col => 2, :row => 14, :answer_item => "11", :items => "listitem::::Har for stærk skyldfølelse", :preferences => "", :prop_mask => 0}),
...
ListItem.new({:question => q2, :col => 2, :row => 15, :answer_item => "12", :items => "listitem::::Bliver let flov eller forlegen", :preferences => "", :prop_mask => 0}),
...
ListItem.new({:question => q2, :col => 2, :row => 16, :answer_item => "13", :items => "listitem::::Uopmærksom eller afledes let", :preferences => "", :prop_mask => 0}),
...
ListItem.new({:question => q2, :col => 2, :row => 17, :answer_item => "14", :items => "listitem::::Stædig, mut eller irritabel", :preferences => "", :prop_mask => 0}),
...
ListItem.new({:question => q2, :col => 2, :row => 18, :answer_item => "15", :items => "listitem::::Anfald af arrigskab eller vrede", :preferences => "", :prop_mask => 0}),
...
ListItem.new({:question => q2, :col => 2, :row => 19, :answer_item => "16", :items => "listitem::::Truer folk", :preferences => "", :prop_mask => 0}),
...
ListItem.new({:question => q2, :col => 2, :row => 20, :answer_item => "17", :items => "listitem::::Ulykkelig, trist eller deprimeret", :preferences => "",	:prop_mask => 0}),
...
ListItem.new({:question => q2, :col => 2, :row => 21, :answer_item => "18", :items => "listitem::::Bekymrer sig", :preferences => "", :prop_mask => 0}),
Rating.new({:question => q2, :col => 1, :row => 22, :answer_item => nil, :items => "radio::0::0###radio::1::1###radio::2::2", :preferences => { :required => true}, :prop_mask => 1}),
ListItem.new({:question => q2, :col => 2, :row => 22, :answer_item => nil, :items => "listitem::::Yderligere spørgsmål###textbox::::", :preferences => "", :prop_mask => 0}),
